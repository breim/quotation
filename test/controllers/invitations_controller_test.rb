...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { company_id: @invitation.company_id, quote_id: @invitation.quote_id, user_id: @invitation.user_id }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { company_id: @invitation.company_id, quote_id: @invitation.quote_id, user_id: @invitation.user_id }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
